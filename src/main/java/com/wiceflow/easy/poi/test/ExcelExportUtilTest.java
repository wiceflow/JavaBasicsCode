package com.wiceflow.easy.poi.test;

import cn.afterturn.easypoi.excel.ExcelExportUtil;
import cn.afterturn.easypoi.excel.entity.ExportParams;
import cn.afterturn.easypoi.excel.entity.enmus.ExcelType;
import com.wiceflow.easy.poi.entity.CourseEntity;
import com.wiceflow.easy.poi.entity.StudentEntity;
import com.wiceflow.easy.poi.entity.TeacherEntity;
...
public class ExcelExportUtilTest {
    ...
    public static void main(String[] args) {
        ExcelExportUtilTest e = new ExcelExportUtilTest();
        e.testBefore();
        try {
            e.testStudentList();
        } catch (Exception e1) {
