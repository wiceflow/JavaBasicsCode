...
public class ArterialTrafficListEntity {
    private int id;
    ...
    @Basic
    @Column(name = "ArterialName", nullable = true, length = 255)
    public String getArterialName() {
        return arterialName;
    }

    public void setArterialName(String arterialName) {
        this.arterialName = arterialName;
    }
    ...
    public boolean equals(Object o) {
        ...
        ArterialTrafficListEntity that = (ArterialTrafficListEntity) o;
        ...
        if (arterialName != null ? !arterialName.equals(that.arterialName) : that.arterialName != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (arterialName != null ? arterialName.hashCode() : 0);
